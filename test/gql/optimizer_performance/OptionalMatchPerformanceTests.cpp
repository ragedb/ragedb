...
TEST_CASE("Optional Match Performance Benchmarks", "[gql_optimizer_perf]") {
    auto graph = Graph("gql_test_optional_match_perf");
    graph.Start().get();
    graph.Clear();
    ...
    std::cout << "\n=========================================\n";
    std::cout << "   OPTIONAL MATCH PERFORMANCE BENCH\n";
    std::cout << "=========================================\n";
