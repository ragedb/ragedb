...
TEST_CASE("Limit Pushdown Performance Benchmarks", "[gql_optimizer_perf]") {
    auto graph = Graph("gql_test_limit_pushdown_perf");
    graph.Start().get();
    graph.Clear();
    ...
    std::cout << "\n=========================================\n";
    std::cout << "   LIMIT PUSHDOWN PERFORMANCE BENCH\n";
    std::cout << "=========================================\n";
