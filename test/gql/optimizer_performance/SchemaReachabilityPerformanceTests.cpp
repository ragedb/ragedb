...
TEST_CASE("Schema Reachability Performance Benchmarks", "[gql_optimizer_perf]") {
    auto graph = Graph("gql_test_schema_reachability_perf");
    graph.Start().get();
    graph.Clear();
    ...
    std::cout << "\n=========================================\n";
    std::cout << "   SCHEMA REACHABILITY PERFORMANCE BENCH\n";
    std::cout << "=========================================\n";
